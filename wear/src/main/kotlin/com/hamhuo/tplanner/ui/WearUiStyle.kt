...
internal val WEAR_BOLD: Typeface = Typeface.create("sans-serif", Typeface.BOLD)
internal val WEAR_MONOSPACE: Typeface = Typeface.create(Typeface.MONOSPACE, Typeface.NORMAL)
